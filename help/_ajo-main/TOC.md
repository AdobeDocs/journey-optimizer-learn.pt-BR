...
+ Campanhas {#create-campaigns}
  + Campanhas de ações {#action-campaigns}
    ...
    + [Criar uma campanha no aplicativo](/help/campaigns/action-campaigns/in-app.md)
    + [Configurar e enviar uma campanha por push](/help/campaigns/action-campaigns/push-campaign.md)
    + [Criar uma campanha da web](/help/campaigns/action-campaigns/web-campaign.md)
    ...
    + [Utilizar a otimização de mensagens em uma campanha](/help/campaigns/action-campaigns/leverage-message-optimization-in-a-campaign.md)
  ...
  + Campanhas orquestradas {#orchestrated-campaigns}
    ...
    + [Configurar esquemas e conjuntos de dados para campanhas orquestradas](/help/campaigns/orchestrated-campaigns/set-up-schemas-and-datasets-for-orchestrated-campaigns.md)
...
+ Jornadas {#journeys}
  ...
  + [Introdução à nova tela da jornada](/help/journeys/introduction-to-the-new-journey-canvas.md)
...
+ [Fidelidade](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/loyalty/overview)
...
+ Perfis, públicos-alvo e assinaturas {#profiles-audiences-subscriptions}
  ...
  + [Avaliar públicos-alvo por demanda](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/audiences/audience-builder/evaluate-audiences-on-demand)
  + [Páginas de assinaturas e de destino](/help/profiles-audiences-subscriptions/subscriptions-and-landing-pages.md)
+ Canais {#channels}
  ...
  + Canal de email{#email-channel}
    ...
    + [Criação de conteúdo consistente com a marca viabilizada por IA - Tutorial](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/create-on-brand-content/overview)
  ...
  + [Configurar e usar canais personalizados](/help/channels/configure-and-use-custom-channels.md)
+ Gerenciamento de conteúdo{#content-management}
  ...
  + [Criar conteúdo consistente com a marca no Journey Optimizer - Tutorial](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/create-on-brand-content/overview)
+ Personalizar conteúdo {#personalize-content}
  ...
  + [Playground do editor de personalização](/help/personalize-content/personalization-editor-playground.md)
...
+ Recursos de decisão{#decision-capabilities}
  + Tomada de decisão {#decisioning}
    ...
    + Use a tomada de decisões para personalizar mensagens {#use-decisioning}
      ...
      + {hide-from-toc}[Usar o serviço de decisão no editor visual da web](/help/decisioning/use-decisioning-within-the-web-visual-editor.md)
  ...
  + Gestão de decisões {#decision-management}
    ...
    + [Criar posicionamentos](/help/decision-management/create-placements.md)
    + [Criar regras](/help/decision-management/create-rules.md)
    + [Criar tags](/help/decision-management/create-tags.md)
    + [Crie ofertas personalizadas](/help/decision-management/create-personalized-offers.md)
...
+ Relatar e monitorar {#report-and-monitor}
  ...
  + [Monitorar ações personalizadas](/help/report-and-monitor/custom-action-monitoring-report.md)
...
+ Configuração {#configuration}
  + Configurar canais {#channel-configuration}
    ...
    + Canal de email {#email-channel}
      + [Criar um pool de IPs](/help/set-up-channels/create-ip-pool.md)
      + [Configurar um subdomínio](/help/set-up-channels/set-up-subdomain.md)
    ...
    + Canal de SMS/MMS/RCS {#sms-mms-channel}
      ...
      + [Configurar RCS](/help/set-up-channels/set-up-rcs.md)
    + Canais da web e dispositivos móveis {#web-and-mobile-channels}
      + [Configuração de canais guiada](/help/set-up-channels/guided-channel-setup.md)
    + Canal do WhatsApp {#whatsapp-channel}
      + [Configurar o canal do WhatsApp](/help/set-up-channels/set-up-whatsapp-channel.md)
...
+ Exercícios, laboratórios e desafios {#exercises-and-challenges}
  ...
  + [Desafios](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}
