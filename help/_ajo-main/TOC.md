...
+ Perfis, públicos-alvo e assinaturas {#profiles-audiences-subscriptions}
   ...
   + [Criar um público-alvo carregando um arquivo CSV](/help/profiles-audiences-subscriptions/import-and-activate-an-audience-by-uploading-a-csv-file.md)
...
+ Gestão de conteúdo{#content-management}
   ...
   + Acelerador de conteúdo do Assistente de IA{#content-accelerator}
      ...
      + [Criar conteúdo com o acelerador de conteúdo do Assistente de IA](/help/content-management/create-content-using-the-ai-assistant-content-accelerator.md)
