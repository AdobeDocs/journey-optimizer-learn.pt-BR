...
+ [Fidelidade](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/loyalty/overview){target="_blank"}
...
+ Canais {#channels}
  ...
  + Atividades ao vivo {#live-activities}
    ...
    + [Configurar atualizações em tempo real do Android](/help/channels/android-live-updates.md)
