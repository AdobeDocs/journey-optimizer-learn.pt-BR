...
+ Casos de uso {#use-cases}
   ...
   + [Personalizando ofertas com dados meteorológicos em tempo real no Adobe Journey Optimizer usando o Web SDK](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction)
   + [Use a fórmula de classificação para fornecer ofertas personalizadas no Journey Optimizer](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction)
...
+ Configuração {#configuration}
   + Configurar canais {#channel-configuration}
      ...
      + Canais da Web e móveis {#web-and-mobile-channels}
...
+ Summit Labs {#summit-labs}
   + [Folha de características do laboratório de 2025 Summit](/help/summit-lab-assets/l535-assets.md)
