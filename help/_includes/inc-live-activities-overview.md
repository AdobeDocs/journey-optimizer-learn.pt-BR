...
As **atividades online** permitem que você forneça atualizações contínuas e em tempo real que mantêm os clientes informados à medida que uma atividade avança — como um pedido que está sendo preparado, uma entrega em trânsito ou uma viagem a caminho. Em vez de enviar uma nova notificação para cada atualização, uma única atividade ativa é criada, atualizada e encerrada conforme a atividade evolui, mantendo a Tela de bloqueio ou a sombra da notificação do cliente sincronizada com o que está acontecendo.
