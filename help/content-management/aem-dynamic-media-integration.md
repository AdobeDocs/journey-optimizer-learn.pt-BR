---
title: Integração com o AEM Dynamic Media
description: Saiba como integrar o Adobe Experience Manager (AEM) Dynamic Media ao Adobe Journey Optimizer (AJO) para permitir atualizações e personalização de conteúdo em tempo real.
feature: Assets
...
# Integração com o Adobe Experience Manager Dynamic Media
