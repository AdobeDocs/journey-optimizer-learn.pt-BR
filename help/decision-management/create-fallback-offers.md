...
>[!VIDEO](https://video.tv.adobe.com/v/341361?quality=12&learn=on&captions=por_br){transcript=true}

Para saber mais sobre como criar ofertas substitutas com uma API, consulte o [manual do produto](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/api-reference/offers-api/fallback-offers/create.html?lang=pt-BR)
