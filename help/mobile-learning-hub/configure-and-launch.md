...
### Componentes necessários do Mobile SDK para casos de uso de dispositivos móveis Journey Optimizer

Para usar os canais móveis do Journey Optimizer (push, no aplicativo, cartões de conteúdo, experiências baseadas em código), você deve instalar e configurar as seguintes extensões:

![Extensões necessárias](/help/mobile-learning-hub/assets/extensions.png)
...
- [Usando a personalização do lado do cliente baseada em CDN (ODD) em dispositivos móveis para personalizações mais rápidas (Blog)](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/using-cdn-based-client-side-personalization-odd-on-mobile-for/ba-p/761626){target="_blank"}