...
<div class="columns">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Optimize Push Notifications with AJO Decisioning">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/decisioning-in-push-notifications" title="Otimizar notificações por push com o AJO Decisioning" target="_blank" rel="referrer">
...
>[!TAB Atividades online]

### Atividades ao vivo

>[!PREREQUISITES]
>
> 1. Verifique se o aplicativo está integrado ao Mobile SDK e configurado com as extensões Live Activity (consulte [Configurar Live Activity](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/live-activity/configure-live-activity/mobile-live-configuration-sdk){target="_blank"}).
...
Saiba como criar e fornecer atualizações do Android Live no Adobe Journey Optimizer, permitindo experiências do cliente em tempo real e persistentes que mantêm os usuários informados à medida que as atividades avançam.

>[!VIDEO](https://video.tv.adobe.com/v/3503646/?learn=on&enablevpops)

#### Documentação do produto

| ![Configurar Atividade Dinâmica ](./assets/configuration.svg)[**Configurar Atividade Dinâmica**](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/live-activity/configure-live-activity/mobile-live-configuration-sdk){target="_blank"} |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
