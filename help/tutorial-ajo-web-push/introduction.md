...
- [Demonstração ao vivo - Aceitação:](https://ajo-web-push.onrender.com/)

- [Evento de queda de preço do acionador:](https://ajo-web-push.onrender.com/price-drop-trigger.html)
