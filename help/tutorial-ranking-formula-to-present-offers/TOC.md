---
user-guide-title: Personalização de ofertas com fórmulas de Classificação com base no CEP e na renda do usuário
user-guide-description: Use as fórmulas de classificação da Adobe Journey Optimizer para fornecer dinamicamente as ofertas financeiras mais relevantes, adaptadas ao CEP e nível de renda de cada usuário, visando maior engajamento e personalização mais inteligente.
role: Developer
level: Beginner
...
+ [Criar campo editável](./editable-fields.md)
+ [Criar uma página da Web](./display-offers.md)
